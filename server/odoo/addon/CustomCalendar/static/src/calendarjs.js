...
function calendarJs( id, options, searchOptions, startDateTime ) {
    var _options = {},
        ...
        _element_HeaderDateDisplay_Text_2 = null,
    ...
    function build( newStartDateTime, fullRebuild ) {
        ...
        console.log(" ######################################")
            ...
            // console.log("333333333",EC)
            $(function() {
          
                var calendar = $.calendars.instance('ethiopian','am');
                $('#popupDatepicker').calendarsPicker({calendar: calendar});
               var date =  $('#inlineDatepicker').calendarsPicker({calendar: calendar,onSelect: showDate});
                console.log("$$$$$$$$$$$$$$$$$",date)
                console.log(date['jQuery331058578070165335122'])
                // console.log(date[0]._day)
                console.log([0].jQuery331058578070165335122)
    
                // console.log([0].jQuery33106435048518972692.calendarsPicker.drawDate._year)
        ...
        var firstDay = new Date( _currentDate.getFullYear(), _currentDate.getMonth(), 1 ),
            ...
            // console.log("getTotalDaysInMonth",getTotalDaysInMonth)
        hideAllDropDowns();
        ...
        _element_HeaderDateDisplay_Text.innerText = _options.monthNames[ (parseInt(_currentDate.getMonth())) ] + ", " + (parseInt(_currentDate.getFullYear()) - 8) + "  " + "  " + "   --  " + "   "
        _element_HeaderDateDisplay_Text_2.innerText = _options.monthNames_en[ (parseInt(_currentDate.getMonth())) ] + ", " + (parseInt(_currentDate.getFullYear())) + " " + _options.dropDownMenuSymbol;
        
        console.log("%%%_currentDate",_currentDate)
        console.log(parseInt(_currentDate.getFullYear()) - 8)

        console.log("-----",_options.monthNames[ _currentDate.getMonth() ] + ", " + (parseInt(_currentDate.getFullYear()) - 8) + " " + _options.dropDownMenuSymbol)
    ...
    function buildDateHeader() {
        ...
        _element_HeaderDateDisplay_Text_2 = createElement( "span" );
        _element_HeaderDateDisplay_Text_2.ondblclick = cancelBubble;
        titleContainer.appendChild( _element_HeaderDateDisplay_Text_2 );
    ...
    function buildYearSelectorDropDown( container ) {
        ...
        _element_HeaderDateDisplay_Text_2.onclick = showYearSelectorDropDownMenu;
    ...
    function buildDateTimeDisplay( container, date, addTime, addYear, addDayName ) {
        console.log("#####buildDateTimeDisplay######")
    ...
    function buildPreviousMonthDays( dateTime, startDay ) {
        console.log("#####buildPreviousMonthDays######",dateTime,startDay)
    ...
    function buildMonthDays( totalDaysInMonth, startDay ) {
        console.log("#####buildMonthDays######",totalDaysInMonth, startDay)
        ...
        // console.log("#####elementDayNumber######",elementDayNumber)

        return elementDayNumber;
    }

    function buildNextMonthDays( lastDayFilled ) {
        console.log("#####buildNextMonthDays######",lastDayFilled)
    ...
    function buildDay( actualDay, elementDayNumber, month, year, isMuted, includeMonthName ) {
        ...
        if ( dayElement !== null ) {
            ...
            console.log("ddddddddddddddd",dayIsToday)
            dayText.className += dayMutedClass;
            dayText.className += dayIsToday && !_datePickerModeEnabled ? " today" : "";
            dayText.innerText = actualDay;
            console.log("ddddddddddddddd",dayIsToday)
    ...
    function setTranslationStringOptions() {
        ...
        if ( isInvalidOptionArray( _options.monthNames, 13 ) ) {
            _options.monthNames = [
        ...
        if ( isInvalidOptionArray( _options.monthNames_en, 13 ) ) {
            _options.monthNames_en = [
        ...
        if ( !isDefinedString( _options.addEventTitle ) ) {
            _options.addEventTitle = "Add Schedule";
        }

        if ( !isDefinedString( _options.editEventTitle ) ) {
            _options.editEventTitle = "Edit Schedule";
            console.log("############# Edit Schedule")
        }

        if ( !isDefinedString( _options.exportStartFilename ) ) {
            _options.exportStartFilename = "exported_Schedules_";
        }
        ...
        if ( !isDefinedString( _options.allEventsText ) ) {
            _options.allEventsText = "All Schedules";
        }
        ...
        if ( !isDefinedString( _options.confirmEventRemoveTitle ) ) {
            _options.confirmEventRemoveTitle = "Confirm Schedule Removal";
        }
        
        if ( !isDefinedString( _options.confirmEventRemoveMessage ) ) {
            _options.confirmEventRemoveMessage = "Removing this Schedule cannot be undone.  Do you want to continue?";
        }
        ...
        if ( !isDefinedString( _options.searchEventsTitle ) ) {
            _options.searchEventsTitle = "Search Schedules";
        }
        ...
        if ( !isDefinedString( _options.noEventsAvailableText ) ) {
            _options.noEventsAvailableText = "No Schedules available.";
        }
        
        if ( !isDefinedString( _options.viewWeekEventsText ) ) {
            _options.viewWeekEventsText = "View Week Schedules";
        }
        
        if ( !isDefinedString( _options.noEventsAvailableFullText ) ) {
            _options.noEventsAvailableFullText = "There are no Schedules available to view.";
        }
        ...
        if ( !isDefinedString( _options.toAddANewEventText ) ) {
            _options.toAddANewEventText = "to add a new Schedule.";
        }
        ...
        if ( !isDefinedString( _options.eventNotificationBody ) ) {
            _options.eventNotificationBody = "The Schedule '{0}' has started.";
        }
        ...
        if ( !isDefinedString( _options.enableAutoRefreshForEventsText ) ) {
            _options.enableAutoRefreshForEventsText = "Enable auto-refresh for Schedules";
        }
        ...
        if ( !isDefinedString( _options.enableDragAndDropForEventText ) ) {
            _options.enableDragAndDropForEventText = "Enable drag & drop for Schedules";
        }
        ...
        if ( !isDefinedString( _options.removeEventsTooltipText ) ) {
            _options.removeEventsTooltipText = "Remove Schedules";
        }

        if ( !isDefinedString( _options.confirmEventsRemoveTitle ) ) {
            _options.confirmEventsRemoveTitle = "Confirm Schedules Removal";
        }
        
        if ( !isDefinedString( _options.confirmEventsRemoveMessage ) ) {
            _options.confirmEventsRemoveMessage = "Removing these non-repeating Schedules cannot be undone.  Do you want to continue?";
        }

        if ( !isDefinedString( _options.eventText ) ) {
            _options.eventText = "Schedule";
        }
        ...
        if ( !isDefinedString( _options.newEventDefaultTitle ) ) {
            _options.newEventDefaultTitle = "* New Schedule";
        }
