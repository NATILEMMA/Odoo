...
odoo.define("AmharicDatepickerCalendar.EthiopianCalanderWidget", function(require){
    "use strict";
    ...
    var EthiopianCalanderWidget = Widget.extend({
        ...
        widget_registry.add('ethiopian_calander_widget', EthiopianCalanderWidget)
