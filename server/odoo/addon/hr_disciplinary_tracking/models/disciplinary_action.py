...
class DisciplinaryAction(models.Model):
    ...
    def _compute_css(self):
        ...
        for record in self:
            if (record.state == 'draft' or record.state == 'explain' or record.state == 'action' or record.state == 'cancel') and self.env.user.has_group('hr_disciplinary_tracking.group_employee_disciplinary_committee') or\
                ...
                (record.state == 'submitted' or record.state == 'action' or record.state == 'cancel') and self.env.user.has_group('hr.group_user_custom'):
