...
class RevisedPlanHistory(models.Model):
    ...
    ethiopian_to = fields.Date(string="Revised Date")
    pagum_to = fields.Char(string="Revised Date")
    is_pagum_to = fields.Boolean(default='True', string="Revised Date")
    ...
    def create(self, vals):
        ...
        try:
            ...
            if vals['revised_date'] is not None:
                date2 = vals['revised_date']
        ...
        res = super(RevisedPlanHistory, self).create(vals)
        try:
            if res.approved_date:
                date1 = res.approved_date
                Edate1 = EthiopianDateConverter.to_ethiopian(date1.year,date1.month,date1.day)
                if type(Edate1) == date:
    ...
    def write(self, vals):
        ...
        try:
            ...
            pass
        return super(RevisedPlanHistory, self).write(vals)
...
class AnnualPlanReport(models.Model):
    _inherit="annual.plan.report"

    ethiopian_from = fields.Date(string="Date From", store=True)
    ...
    def create(self, vals):
        ...
        try:
            ...
            pass
        res = super(AnnualPlanReport, self).create(vals)
        try:
            if res.date_from:
                date1 = res.date_from
                Edate1 = EthiopianDateConverter.to_ethiopian(date1.year,date1.month,date1.day)
    ...
    def write(self, vals):
        ...
        try:
            ...
            pass
        return super(AnnualPlanReport, self).write(vals)
