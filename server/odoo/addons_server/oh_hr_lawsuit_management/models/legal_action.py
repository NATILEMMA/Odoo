...
class HrLawsuit(models.Model):
    ...
    display_name = fields.Char(store=False, default=lambda self: self.ref_no,translate=True)

    ref_no = fields.Char(string="Reference Number",translate=True)
    ...
    other_name = fields.Char(string='Name', help='Enter the details of other type',translate=True)
    party2_name = fields.Char(compute='set_party2', string='Name', store=True,translate=True)
