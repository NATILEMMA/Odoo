...
odoo.define("EthiopianCalander.CalanderWidget", function(require){
    "use strict";
    ...
    let clicked_val = 0
        ...
        var EthiopianCalanderWidgetTwo = Widget.extend({
...
//                   
    ...
    widget_registry.add('ethiopian_calander_widget_two', EthiopianCalanderWidgetTwo)
