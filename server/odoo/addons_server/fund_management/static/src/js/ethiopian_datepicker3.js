...
var widget_three = Widget.extend({
    template: 'widget_three',
    
    events:{},
  
  start: function() {
    console.log("##### FFFFFFFFF Calander Widget Three####")
...
//                     localStorage.setItem('myFlag3', dateTo);
                      // $("#DatepickerFour").val(dateTo);
                          ...
                          console.log("--- Bothssssssssssssss False",data)
  ...
  widget_registry.add('widget_three', widget_three)
});
