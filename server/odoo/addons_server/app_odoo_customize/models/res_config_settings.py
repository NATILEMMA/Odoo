...
class ResConfigSettings(models.TransientModel):
    ...
    app_show_share = fields.Boolean('Show Share Dashboard', help="Uncheck to hide the Odoo Portal Share Dashboard")
    app_show_poweredby = fields.Boolean('Show Powered by Odoo  Technologies', help="Uncheck to hide the Powered by text")
    ...
    def get_values(self):
        ...
        app_system_name = ir_config.get_param('app_system_name', default='Odoo ERP')
