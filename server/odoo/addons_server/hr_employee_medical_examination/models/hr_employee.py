...
class HrEmployee(models.Model):
    ...
    employee_medical_examination_count= fields.Integer(String="medical examination count", default = 0 ,help="this is a counter field for graph view. since computed fields are not possible on graph view we use this instead")
    ...
    def _compute_medical_examination_count(self):
        for record in self:
            ...
            record.employee_medical_examination_count = len(record.medical_examination_ids)
