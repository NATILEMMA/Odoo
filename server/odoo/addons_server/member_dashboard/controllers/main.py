    ...
    def account(self, redirect=None, **post):
        ...
        if post and request.httprequest.method == 'POST':
            ...
            if post['image_1920']:
                ...
                return request.render("member_dashboard.profile_end", {"users": users, "is_users": is_users, 'is_member': is_member})
            else:
                post.pop('image_1920')
        ...
        response = request.render("member_dashboard.portal_details", values)
...
#            'perpertrators': perpertrators,
    ...
    def delete_complaint(self, id, **kwargs):
        ...
        complaint = request.env['member.complaint'].sudo().search([('id', '=', id)])
        complaint.unlink()
        return request.render('member_dashboard.delete_complaint_end', {'users': users, 'is_users': is_users, 'is_member': is_member})
...
#        perps = request.httprequest.form.getlist('perpertrators')
        ...
        if partner_id.is_league == False and partner_id.is_member == False and partner_id.is_leader == False:
            return request.render("member_dashboard.register_error_6", {'is_users': is_users, 'is_member': is_member})
        ...
        #     })
          ...
          return request.redirect('/my/complaint')
            ...
            return request.render("member_dashboard.complaint_end", {"users": users, "is_users": is_users, 'is_member': is_member})
    ...
    def complaint_data(self, **kwargs):
        ...
        return request.render("member_dashboard.complaint_list", {
                                    'record': complaint,
                                    "users":users,
                                    'is_users': is_users,
                                    'is_member': is_member
    ...
    def for_which_year(self, year, league, member, leader, **kwargs):
        ...
        if year_id != 0:
            if is_league:
                league_payments = request.env['each.league.payment'].search([('year_id', '=', year)])
            if is_member or is_leader:
                payments = request.env['each.member.payment'].search([('year_id', '=', year)])
        else:
            payments = []
    ...
    def payment_data(self, **kwargs):
        ...
        if partner_id.is_league == True:
            ...
            return request.render("member_dashboard.member_payments", {
...
#            'perpertrators': perpertrators,
    ...
    def add_attachments(self, **kwargs):
        ...
        if partner.is_league == False and partner.is_member == False and partner.is_leader == False:
            return request.render("member_dashboard.register_error_7", {'is_users': is_users, 'is_member': is_member})
    ...
    def get_transfers(self, **kwargs):
        ...
        return request.render("member_dashboard.all_tranfer_member", {
                                                                        'transfers': transfers,
                                                                        'users':users,
                                                                        'is_users': is_users,
                                                                        'is_member': is_member
    ...
    def delete_transfer(self, id, **kwargs):
        ...
        transfer.unlink()
        return request.render('member_dashboard.delete_transfer_end', {'users': users, 'is_users': is_users, 'is_member': is_member})
    ...
    def edit_transfer(self, id, **kwargs):
        ...
        if current_job:
            ...
            place_of_work = ''
        return request.render("member_dashboard.tranfer_member", {
                                                                    'transfers': transfers,
                                                                    'partner': partner,
                                                                    'subcity': subcity,
                                                                    'wereda': wereda,
    ...
    def create_transfer(self, **kwargs):
        ...
        if kwargs and request.httprequest.method == 'POST':
            ...
            if values['partner'] and values['transfers']:
                ...
                if len(transfers) > 0:
                    return request.render("member_dashboard.register_error_5", {'is_users': is_users, 'is_member': is_member, 'users': users})

                if values['is_league'] == '' and values['is_member'] == '' and values['is_leader'] == '':
                    return request.render("member_dashboard.register_error_4", {'is_users': is_users, 'is_member': is_member, 'users': users})
                ...
                if values['is_league'] == 'True':
                    if values['transfer_as_a_league_or_member'] == 'member' and values['is_member'] == False and values['is_leader'] == False:
                        return request.render("member_dashboard.register_error", {'is_users': is_users, 'is_member': is_member, 'users': users})
                    if values['transfer_as_a_league_or_member'] == False:
                        return request.render("member_dashboard.register_error_3", {'is_users': is_users, 'is_member': is_member, 'users': users})
                ...
                if values['is_leader'] == 'True':
                    if values['transfer_as_a_leader_or_member'] == 'league' and values['is_league'] == False:
                        return request.render("member_dashboard.register_error_1", {'is_users': is_users, 'is_member': is_member, 'users': users})
                ...
                if values['is_member'] == 'True':
                    if values['transfer_as_a_league_or_member'] == 'league' and values['is_league'] == False:
                        return request.render("member_dashboard.register_error_2", {'is_users': is_users, 'is_member': is_member, 'users': users})
                    if values['transfer_as_a_league_or_member'] == False:
                        return request.render("member_dashboard.register_error_3", {'is_users': is_users, 'is_member': is_member, 'users': users})
                    values['membership_org'] = partner.membership_org.id
                ...
                return request.render("member_dashboard.register_end", {'is_users': is_users, 'is_member': is_member, 'users': users})
        is_leader = partner.is_leader
        is_member = partner.is_member
        is_league = partner.is_league
        fee = partner.membership_monthly_fee_cash + partner.membership_monthly_fee_cash_from_percent
    ...
    def profile(self, redirect=None, **post):
        ...
        if post and request.httprequest.method == 'POST':
            ...
            if partner.is_league == False and partner.is_member == False and partner.is_leader == False:
                return request.render("member_dashboard.register_error_8", {'is_users': is_users, 'is_member': is_member})
    ...
    def myreports(self,  **kw):
        ...
        return http.request.render('member_dashboard.my_report', {"users":users, 'is_users': is_users, 'is_member': is_member})
