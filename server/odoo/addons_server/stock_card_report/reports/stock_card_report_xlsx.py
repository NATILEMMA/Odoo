...
class ReportStockCardReportXlsx(models.AbstractModel):
    ...
    def _get_ws_params(self, wb, data, product):
        ...
        stock_card_template = {
            ...
            "1_quantity_in": {
                "header": {"value": "Input Quantity"},
                "data": {"value":self._render("quantity_in")},
                "width": 20,
            },
            "2_unit_cost": {
                "header": {"value": "Input unit price"},
                "data": {"value":self._render("unit_cost_in")},
                "width": 20,
            },
            "3_total_price_in": {
                "header": {"value": "Input total price"},
                "data": {"value":self._render("total_price_in")},
                "width": 20,
            },
            "4_quantity_out": {
                "header": {"value": "Output Quantity"},
                "data": {"value":self._render("quantity_out") },
                "width": 20,
            },
            "5_unit_cost_out": {
                "header": {"value": "Output unit price"},
                "data": {"value":self._render("unit_cost_out")},
                "width": 20,
            },
            "6_total_price_out": {
                "header": {"value": "Output total price"},
                "data": {"value":self._render("total_price_out")},
                "width": 20,
            },
            "7_balance_quantity": {
                "header": {"value": "Balance Quantity"},
                "data": {"value": self._render("balance_quantity"),"format": self.format_tcell_center},
                "width": 20,
            },
            "8_balance_unit_value": {
                "header": {"value": "Balance unit price"},
                "data": {"value": self._render("balance_unit_value"),"format": self.format_tcell_center},
                "width": 15,
            },
            "9_balance_total_value": {
                "header": {"value": "Balance Total price"},
                "data": {"value": self._render("balance_total_value"),"format": self.format_tcell_center},
                "width": 20,
            },
            "10_create_date": {
                "header": {"value": "Date"},
            ...
            "11_reference": {
             ...
             "12_uom_name": {
                "header": {"value": "Unit of measurement"},
                "data": {
                    "value": self._render("uom_name"),
                    "format": self.format_tcell_center,
                },"width": 20,
            },
        }
    ...
    def _stock_card_report(self, wb, ws, ws_params, data, objects, product):
        ...
        for line in product_lines:
            ...
            balance_total_value = balance * line.cost_price
            product_in_total = line.product_in * line.price_unit
            product_out_total = line.product_out * line.price_unit
            if line.product_in == 0.0:
                unit_cost_in = "-"
                product_in_total = "-"
            else :
                unit_cost_in = line.price_unit
            if line.product_out == 0.0:
                unit_cost_out = "-"
                product_out_total = "-"
            else :
                unit_cost_out = line.price_unit
            row_pos = self._write_line(
                ws,
                row_pos,
                ws_params,
                ...
                render_space={
                    ...
                    "quantity_in": line.product_in or "-",
                    "unit_cost_in": unit_cost_in,
                    "total_price_in": product_in_total,
                    "quantity_out": line.product_out or "-",
                    "unit_cost_out": unit_cost_out,
                    "total_price_out": product_out_total,
                    "balance_quantity": balance or 0,
                    "balance_unit_value": line.cost_price,
                    "balance_total_value": balance_total_value or 0,  
                },
