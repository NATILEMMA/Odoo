...
class Grade(models.Model):
  ...
  _sql_constraints = [
                      ...
                      ('check_on_fixed_wage', 'CHECK(minimum_wage <= fixed_wage AND maximum_wage >= fixed_wage)', 'Minimum wage must less or equal to fixed Wage and Maximum wage must greater or equal to fixed Wage'),
