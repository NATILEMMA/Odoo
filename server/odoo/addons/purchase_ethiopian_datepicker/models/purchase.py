...
class PurchaseOrder(models.Model):
    ...
    def create(self, vals):
        ...
        try:
            ...
            if vals['ethiopian_to'] is not None:
                ...
                vals['date_approve'] = date_gr_from
        ...
        try:
            if vals['date_order'] is not None:
                date1 = vals['date_order']
    ...
    def write(self, vals):
        ...
        try:
          if vals['date_approve'] is not None:
                print("vals['date_approve']", vals['date_approve'])
                date_str = vals['date_approve']
                print("date_str",date_str)
                date_time_obj = str(date_str).split(' ')
                print("date_str",date_time_obj[0])
