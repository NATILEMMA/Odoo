...
class HrLoan(models.Model):
    ...
    # def is_normal_employee_user(self):
    #     user = self.env.user
    ...
    name = fields.Char(string="Loan Name", default="/", readonly=True, help="Name of the loan", store=True,translate=True)
    date = fields.Date(string="Date", default=fields.Date.today(), readonly=True, help="Date")
    employee_id = fields.Many2one('hr.employee', string="Employee", required=True, help="Employee",readonly=True,store=True)
    ...
    is_manager = fields.Boolean(string="is user only",default =lambda self : self.env.user.has_group('hr.group_hr_user') or self.env.user.has_group('hr.group_hr_manager')) 
...
class HrEmployee(models.Model):
    ...
    is_manager = fields.Boolean(default =lambda self : self.env.user.has_group('hr.group_hr_user') or self.env.user.has_group('hr.group_hr_manager')) 
