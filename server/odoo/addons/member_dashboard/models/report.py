...
class MembershipReport(models.Model):
    ...
    how_did_you_find = fields.Char("How did you find out about the Segar Scholarship project?",translate=True)
    how_often_do_you = fields.Char("How often do you use or access the scholarship portal?",translate=True)
    your_participation = fields.Char("What was your participation?",translate=True)
    rate_your_level = fields.Char("Please rate your level of satisfaction with the project",translate=True)
    how_do_you_evaluate = fields.Char("How do you evaluate the time you spent on this project?",translate=True)
    suggestions = fields.Char("Do you have any suggestions to improve this activity?",translate=True)
