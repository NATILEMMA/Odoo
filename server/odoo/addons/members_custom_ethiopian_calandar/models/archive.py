...
class ArchivedInformation(models.Model):
    ...
    def create(self, vals):
        ...
        try:
            if vals['date_from'] is not None or vals['date_to'] is not None:
            ...
            pass
        return super(ArchivedInformation, self).create(vals)
    ...
    def write(self, vals):
        ...
        try:
            ...
            pass
        return super(ArchivedInformation, self).write(vals)
