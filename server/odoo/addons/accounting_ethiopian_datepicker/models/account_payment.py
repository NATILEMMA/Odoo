...
class AccountPayment(models.Model):
    ...
    def create(self, vals):
        ...
        try:
            if vals['payment_date'] is not None:
                date1 = vals['payment_date']
        ...
        # if vals['payment_date'] is not None:
        #     date1 = vals['payment_date']
        #     _logger.info("$$$$$$$$$ %s",vals['payment_date'] )
    ...
    def post(self):
         ...
         if not self.payment_date:
             raise ValidationError(_("please selecet date for the payment"))
