...
class ResPartner(models.Model):
    ...
    signup_token = fields.Char(copy=False, groups="base.group_erp_manager", translate=True)
    signup_type = fields.Char(string='Signup Token Type', copy=False, groups="base.group_erp_manager", translate=True)
    ...
    signup_url = fields.Char(compute='_compute_signup_url', string='Signup URL', translate=True)
