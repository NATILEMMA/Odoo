odoo.define("stock_card_report.stock_card_report_backend_custom", function(require) {
    "use strict";
    ...
    core.action_registry.add("stock_card_report_backend_custom", report_backend);
