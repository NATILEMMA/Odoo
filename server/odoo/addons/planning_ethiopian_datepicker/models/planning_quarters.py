...
class ProjectMilestone(models.Model):
    ...
    def create(self, vals):
        ...
        q_type = self.env['planning.quarter'].sudo().search([('id','=',vals.get('name'))],limit=1)
        try:
            vals['start_date'] = q_type.start_date
...
class Quarters(models.Model):
    ...
    def create(self, vals):
        ...
        try:
            ...
            pass
        return super(Quarters, self).create(vals)
    ...
    def write(self, vals):
        ...
        try:
            ...
            pass
        return super(Quarters, self).write(vals)
