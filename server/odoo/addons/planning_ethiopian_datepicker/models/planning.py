...
class Project(models.Model):
    ...
    def create(self, vals):
        ...
        #     if i == (len(pick3)-1):
        #         date2 = EthiopianDateConverter.to_gregorian(pick3[i]['year'],pick3[i]['month'],pick3[i]['day'])
        #         Edate2 = EthiopianDateConverter.to_ethiopian(date2.year,date2.month,date2.day)
        #         _logger.info("^^^^^^^^^^^ %s",type(Edate2))
        ...
        #     if i == (len(pick4)-1):
        #         date2 = EthiopianDateConverter.to_gregorian(pick4[i]['year'],pick4[i]['month'],pick4[i]['day'])
        #         Edate2 = EthiopianDateConverter.to_ethiopian(date2.year,date2.month,date2.day)
        #         _logger.info("^^^^^^^^^^^ %s",type(Edate2))
        ...
        #             if type(Edate2) ==   date:
        #                 vals['actual_date_end'] = date2
        #                 vals['ethiopian_four'] = Edate2
                        # pick4.clear()

        
        try:
            
            if vals['date_start'] is not None and vals['date'] is not None:
