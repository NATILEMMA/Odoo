...
class QuartersGoals(models.Model):
    ...
    def create(self, vals):
        ...
        try:
            ...
            if vals['start_date'] is not None and vals['end_date'] is not None:
            ...
            pass
        return super(QuartersGoals, self).create(vals)
    ...
    def write(self, vals):
        ...
        try:
            ...
            pass
        return super(QuartersGoals, self).write(vals)

    @api.onchange('quarter_type')
    def _compute_quarters_type(self):
        _logger.info("################# ALLLLL DATA %s", self)
        _logger.info(" Name: %s",self.quarter_type)
        _logger.info(" Name: %s",self.ethiopian_from)
        _logger.info(" Name: %s",self.ethiopian_to)
 ...
 # For initial date to widget One
            ...
            _logger.info("DDDDDDDDDDDDDDDDDDData %s",From)
            _logger.info("DDDDDDDDDDDDDDDDDDData %s",to)
