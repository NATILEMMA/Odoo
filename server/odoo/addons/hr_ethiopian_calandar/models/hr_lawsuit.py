...
class Lawsuit(models.Model):
    _inherit = 'lawsuit.appointment_stack'
    ...
    _sql_constraints = [
    ('date_check', 'CHECK ( (ethiopian_to <= ethiopian_from) )', 'The requested date must be before hearing date.')
    ]
    ...
    def create(self, vals):
        ...
        try:
            ...
            if vals['ethiopian_to'] is not None:
                ...
                vals['requested_date'] = date_gr_from
        ...
        try:
            ...
            if vals['ethiopian_from'] is not None:
                ...
                vals['hearing_date'] = date_gr_from
        ...
        try:
            if vals['hearing_date'] is not None :
                date1 = vals['hearing_date']
        ...
        return super(Lawsuit, self).create(vals)
    ...
    def write(self, vals):
        ...
        return super(Lawsuit, self).write(vals)
