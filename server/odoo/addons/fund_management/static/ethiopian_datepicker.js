...
odoo.define("fund_management.fund_managementWidget", function(require){
    "use strict";
    ...
    var fund_managementWidget = Widget.extend({
        ...
        widget_registry.add('ethiopian_calander_widget', fund_managementWidget)
...
//     widget_registry.add('ethiopian_calander_widget_three', fund_managementWidget)
