...
class ResCompany(models.Model):
    ...
    bank_account_code_prefix = fields.Char(string='Prefix of the bank accounts', translate=True)
    cash_account_code_prefix = fields.Char(string='Prefix of the cash accounts', translate=True)
    ...
    transfer_account_code_prefix = fields.Char(string='Prefix of the transfer accounts', translate=True)
