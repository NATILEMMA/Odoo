...
class CreateLeader(models.TransientModel):
    ...
    def action_done(self):
        ...
        mail_temp = self.env.ref('member_registration.leader_approval')
...
class CreateLeague(models.TransientModel):
    ...
    def action_done(self):
        ...
        mail_temp = self.env.ref('member_registration.league_approval')
...
class CreateLeagueMember(models.TransientModel):
    ...
    def action_done(self):
        ...
        mail_temp = self.env.ref('member_registration.member_approval')
        mail_temp.send_mail(wizard.member_id.id)
        user = self.env.user
...
class CreateCandidateMember(models.TransientModel):
    ...
    def action_done(self):
        ...
        partner = self.env['res.partner'].create({
            ...
            'residential_subcity': wizard.candidate_id.residential_subcity,
            'residential_wereda': wizard.candidate_id.residential_wereda,
        ...
        mail_temp = self.env.ref('member_registration.candidate_approval')
