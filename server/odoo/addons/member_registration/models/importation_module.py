            ...
            if record.is_league and not record.is_member:
                ...
                if partner.league_responsibility.id == 1:
                    ...
                    if partner.league_sub_responsibility.id == 1: # Cell Finance
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_finance').id])]
                            })
                        ...
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_assembler').id])]
                            })
                        partner.league_member_cells.league_leaders_ids = [(5, 0, 0)]
                        partner.league_member_cells.league_leaders_ids = [(6, 0, all_league_leaders)]
                        ...
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_main_finance').id])]
                            })
                        ...
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_main_assembler').id])]
                            })
                        partner.league_member_cells.leagues_ids = [(5, 0, 0)]
                        partner.league_member_cells.leagues_ids = [(6, 0, all_leagues)]
                    else:
                ...
                if partner.league_responsibility.id == 2:
                    ...
                    if partner.league_sub_responsibility.id == 1: # Cell Finance
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_finance').id, self.env.ref('member_minor_configuration.member_group_cell_manager').id])]
                            })
                        partner.league_member_cells.league_leaders_ids = [(5, 0, 0)]
                        partner.league_member_cells.league_leaders_ids = [(6, 0, all_league_leaders)]
                    elif partner.league_sub_responsibility.id == 2: # Cell Assembler
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_assembler').id, self.env.ref('member_minor_configuration.member_group_cell_manager').id])]
                            })
                        partner.league_member_cells.league_leaders_ids = [(5, 0, 0)]
                        partner.league_member_cells.league_leaders_ids = [(6, 0, all_league_leaders)]
                    else:
                ...
                if partner.league_responsibility.id == 3:
                    ...
                    if partner.league_sub_responsibility.id == 3: # Main Office Finance
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_main_finance').id, self.env.ref('member_minor_configuration.member_group_main_manager').id])]
                            })
                        partner.league_member_cells.leagues_ids = [(5, 0, 0)]
                        partner.league_member_cells.leagues_ids = [(6, 0, all_leagues)]
                    elif partner.league_sub_responsibility.id == 4: # Main Office Assembler
                        if user:
                            user.write({
                                'groups_id': [(6, 0, [self.env.ref('base.group_user').id, self.env.ref('member_minor_configuration.member_group_main_assembler').id, self.env.ref('member_minor_configuration.member_group_main_manager').id])]
                            })
                        partner.league_member_cells.leagues_ids = [(5, 0, 0)]
                        partner.league_member_cells.leagues_ids = [(6, 0, all_leagues)]
                    else:
