...
class VisitDetails(models.Model):
    ...
    ethiopian_from = fields.Date(string="Date", store=True)
    pagum_from = fields.Char(string="Date", store=True,translate=True)
...
class EmployeeEntry(models.Model):
    ...
    def create(self, vals):
        ...
        res = super(EmployeeEntry, self).create(vals)
    ...
    def write(self, vals):
        ...
        try:
            ...
            pass
        return super(EmployeeEntry, self).write(vals)
